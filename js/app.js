...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img  class="product-image" src="${image}">
      ...
      <p class="product-rating">Rating: ${product.rating.rate}          Rating count: ${product.rating.count}</p>
...
//After Buying get the initial value
...
//load all the products  for inital 
loadProducts();
